...
public class IdConverterBuilder {
	...
	@SuppressWarnings("optional:method.invocation") // true positive : lambda closes over the value of an optional that might be present at capture but not at invocation.
